...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        moderator_lst=['view_lesson','change_lesson','view_course', 'change_course','view_customuser']
        ...
        user_lst=   ['view_lesson','change_lesson','add_lesson','delete_lesson',
                    'view_course', 'change_course','add_course','delete_course',
                    'view_customuser','change_customuser','add_customuser','view_payment']
        user_permissions=[]
        for i in user_lst:
